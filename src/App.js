    ...
    <div>
      ...
      <div id="home" className="h-screen bg-gradient-to-r from-blue-800 to-blue-400">
        <div className="flex flex-col w-full h-full p-12 md:flex-row">
          <div className="flex-grow flex  h-full flex-col justify-center p-6 md:mt-16">
            ...
            <div className='flex flex-row md:mt-10 mt-3 items-center justify-center md:justify-start align-middle md:mb-8'>
          ...
          <img className="items-center justify-center md:mt-32 md:h-1//2 md:w-1/2" src={Image} alt="Image" />
          </div>
        </div>
      </div>
      <div id='about' className='h-full w-full'>
        ...
        <div className='md:p-10 p-4 md:pr-20 h-1/4 flex md:gap-16 flex-col md:flex-row items-center justify-center bg-gradient-to-r from-blue-800 to-blue-400'>
          <div className='md:w-1/4 max-md:mt-4 items-center flex justify-center'>
            <img className="items-center justify-center md:mt-20 h-52 w-52 md:h-60 md:w-60" src={Image} alt="Image" />
          </div>
          <div className='md:w-1/3 w-2/3 text-white'>
            <h1 className='text-center md:text-right font-bold text-[32px] md:text-[45px]   mb-4'>SOBRE NÓS</h1>
